...
Se han propuesto métodos para hacer uso de dispositivos o métodos complejos, o para mutilar de tal manera los impulsos normales que se vuelvan ininteligibles para cualquier adversario que intercepte la línea o intercepte las señales si se envían por radio. Cualquier sistema de este tipo puede ser "roto" fácilmente por alguien que tenga conocimiento de los métodos utilizados y la capacidad para ensamblar y operar el aparato necesario.
...
Este tipo de cifrado puede distinguirse por el hecho de que el gráfico de frecuencia es bastante plano, la frecuencia de ocurrencia de todas las letras siendo aproximadamente la misma. Cada alfabeto de cifrado se usa repetidamente a intervalos regulares. Al encontrar este intervalo y luego estudiar cada alfabeto por separado, los mensajes de este tipo pueden descifrarse fácilmente por un experto.
